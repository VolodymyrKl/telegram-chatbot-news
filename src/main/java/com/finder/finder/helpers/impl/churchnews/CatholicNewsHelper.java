...
@Component
public class CatholicNewsHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(CatholicNewsHelper.class);
    ...
    public List<Item> getItems() {
        Rss rss = null;
        try {
            logger.info("Start getting news from Catholic news agency.");
            JAXBContext jaxbContext = JAXBContext.newInstance(Rss.class);
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            URL url = new URL("http://feeds.feedburner.com/catholicnewsagency/dailynews-vatican");
