...
@Component
public class ChurchLeadersHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(ChurchLeadersHelper.class);
    ...
    public List<Item> getItems() {
        Rss rss = null;
        try {
            logger.info("Start getting news from Church Leaders.");
            JAXBContext jaxbContext = JAXBContext.newInstance(Rss.class);
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            URL url = new URL("https://churchleaders.com/feed");
