...
@Component
public class OrthodoxTimesHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(OrthodoxTimesHelper.class);
    ...
    public List<Item> getItems() {
        Rss rss = null;
        try {
            logger.info("Start getting news from Orthodox times.");
            JAXBContext jaxbContext = JAXBContext.newInstance(Rss.class);
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            URL url = new URL("https://orthodoxtimes.com/feed/");
