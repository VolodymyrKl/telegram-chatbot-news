...
@Component
public class KatholisсhDEHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(KatholisсhDEHelper.class);
    ...
    public List<Item> getItems() {
        Rss rss = null;
        try {
            logger.info("Start getting news from katholisсh.de.");
            JAXBContext jaxbContext = JAXBContext.newInstance(Rss.class);
            Unmarshaller unmarshaller = jaxbContext.createUnmarshaller();
            URL url = new URL("https://www.katholisch.de/aktuelles.rss");
