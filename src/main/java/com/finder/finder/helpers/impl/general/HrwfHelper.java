...
@Component
public class HrwfHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(HrwfHelper.class);
    ...
    public List<Item> getItems() {
        ...
        try {
            ...
            URL url = new URL("https://hrwf.eu/feed/");
