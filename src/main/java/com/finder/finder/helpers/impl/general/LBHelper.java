...
@Component
public class LBHelper extends AbstractRequestSenderService implements ItemsHandler {

    private static Logger logger = LogManager.getLogger(LBHelper.class);
    ...
    public List<Item> getItems() {
        ...
        try {
            ...
            URL url = new URL("https://lb.ua/rss/ukr/news.xml");
