...
public class PolandChurchHelper extends AbstractRequestSenderService implements ItemsHandler {
    ...
    public List<Item> getItems() {
        ...
        try {
            ...
            URL url = new URL("https://www.orthodox.pl/aktualnosci/feed/");
        ...
        if (Objects.nonNull(rss)) {
            ...
            for (Item item : filteredItems) {
                item.setTitle(itemsService.translateItem("pl", "uk", item.getTitle()));
                item.setDescription(itemsService.translateItem("pl", "uk", item.getDescription()));
            }
